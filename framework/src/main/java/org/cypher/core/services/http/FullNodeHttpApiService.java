...
import org.cypher.core.services.filter.HttpApiAccessFilter;
import org.cypher.core.services.filter.HttpInterceptor;
import org.cypher.core.services.filter.LiteFnQueryHttpFilter;
...
public class FullNodeHttpApiService implements Service {
  ...
  @Autowired
  private GetBurnCypServlet getBurnCypServlet;
  @Autowired
  ...
  public void start() {
    try {
      ...
      context.addServlet(new ServletHolder(getBurnCypServlet), "/wallet/getburncyp");
