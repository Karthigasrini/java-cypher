package org.cypher.core.zen.note;

import static org.tron.common.zksnark.JLibsodium.CRYPTO_AEAD_CHACHA20POLY1305_IETF_NPUBBYTES;
import static org.cypher.core.utils.ZenChainParams.ZC_ENCCIPHERTEXT_SIZE;
import static org.cypher.core.utils.ZenChainParams.ZC_ENCPLAINTEXT_SIZE;
import static org.cypher.core.utils.ZenChainParams.ZC_OUTCIPHERTEXT_SIZE;
import static org.cypher.core.utils.ZenChainParams.ZC_OUTPLAINTEXT_SIZE;
import static org.cypher.core.zen.note.NoteEncryption.Encryption.NOTEENCRYPTION_CIPHER_KEYSIZE;
...
import org.cypher.core.utils.ZenChainParams;
import org.cypher.core.zen.address.DiversifierT;
import org.cypher.core.zen.note.NoteEncryption.Encryption.EncCiphertext;
import org.cypher.core.zen.note.NoteEncryption.Encryption.EncPlaintext;
import org.cypher.core.zen.note.NoteEncryption.Encryption.OutCiphertext;
import org.cypher.core.zen.note.NoteEncryption.Encryption.OutPlaintext;
...
public class NoteEncryption {
  ...
  public static class Encryption {
    ...
    public static void prfOck(byte[] ock, byte[] ovk, byte[] cv, byte[] cm, byte[] epk)
      ...
      byte[] temp = "Zcypher_Derive_ock".getBytes();
    ...
    public static void kdfSapling(byte[] kEnc, byte[] sharedsecret, byte[] epk)
      ...
      byte[] personalization = new byte[JLibsodium.CRYPTO_GENERICHASH_BLAKE2B_PERSONALBYTES];
      byte[] temp = "Zcypher_SaplingKDF".getBytes();
      System.arraycopy(temp, 0, personalization, 0, temp.length);
      if (JLibsodium.cryptoGenerichashBlack2bSaltPersonal(new Black2bSaltPersonalParams(
