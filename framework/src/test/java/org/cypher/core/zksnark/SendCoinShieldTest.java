...
import static org.cypher.core.capsule.TransactionCapsule.getShieldTransactionHashIgnoreTypeException;
...
import org.cypher.common.zksnark.IncrementalMerkleTreeContainer.EmptyMerkleRoots;
...
import org.cypher.common.zksnark.MerklePath;
import org.cypher.common.zksnark.ZksnarkClient;
...
public class SendCoinShieldTest {
  ...
  public void createCapsule() {
    ...
    AssetIssueContract assetIssueContract = AssetIssueContract.newBuilder()
        ...
        .setId(Long.toString(tokenId)).setTotalSupply(OWNER_BALANCE).setCypNum(CYP_NUM).setNum(NUM)
