package org.cypher.core.zksnark;
...
import org.cypher.core.actuator.ActuatorCreator;
...
import org.cypher.core.capsule.ReceiveDescriptionCapsule;
import org.cypher.core.capsule.SpendDescriptionCapsule;
...
import org.cypher.core.db.BlockGenerate;
...
import org.cypher.core.services.http.FullNodeHttpApiService;
import org.cypher.core.utils.TransactionUtil;
import org.cypher.core.zen.ZenTransactionBuilder;
import org.cypher.core.zen.ZenTransactionBuilder.ReceiveDescriptionInfo;
import org.cypher.core.zen.ZenTransactionBuilder.SpendDescriptionInfo;
...
import org.cypher.core.zen.note.Note.NotePlaintextEncryptionResult;
...
public class ShieldedReceiveTest extends BlockGenerate {
  ...
  private static final String ASSET_NAME = "cyp";
  private static final int CYP_NUM = 10;
  private static final int NUM = 1;
  private static final long START_TIME = 1;
  private static final long END_TIME = 2;
  private static final int VOTE_SCORE = 2;
  private static final String DESCRIPTION = "CYP";
  private static final String URL = "https://cypher.network";
  ...
  private static byte[] randomUint256() {
    return org.cypher.keystore.Wallet.generateRandomBytes(32);
  }

  private static byte[] randomUint640() {
    return org.cypher.keystore.Wallet.generateRandomBytes(80);
  }

  private static byte[] randomUint1536() {
    return org.cypher.keystore.Wallet.generateRandomBytes(192);
  }

  private static byte[] randomUint4640() {
    return org.cypher.keystore.Wallet.generateRandomBytes(580);
  }
 ...
 */
  ...
  public void testDiversifierT() throws ZksnarkException {
    //byte[] data = org.cypher.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public void testMemoTooLong() throws ContractValidateException, TooBigTransactionException,
    ...
    byte[] memo = org.cypher.keystore.Wallet.generateRandomBytes(1024);
    ...
    for (org.cypher.protos.Protocol.Transaction.Contract c : t.getRawData().getContractList()) {
  ...
  public void testMemoNotEnough() throws ContractValidateException, TooBigTransactionException,
    ...
    IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
    PaymentAddress paymentAddress = incomingViewingKey.address(new DiversifierT()).get();
    byte[] memo = org.cypher.keystore.Wallet.generateRandomBytes(128);
    builder.addOutput(expsk.getOvk(), paymentAddress,
        100 * 1000000L - wallet.getShieldedTransactionFee(), memo);
  ...
  public void pushSameSkAndScanAndSpend() throws Exception {
    ...
    byte[] memo = org.cypher.keystore.Wallet.generateRandomBytes(512);
    ...
    byte[] cypId = transactionCap.getTransactionId().getBytes();
    boolean ok = dbManager.pushTransaction(transactionCap);
    Assert.assertTrue(ok);
    ...
    for (int i = 0; i < notes1.getNoteTxsCount(); i++) {
      ...
      outPointBuild.setHash(ByteString.copyFrom(cypId));
    ...
    for (int i = 0; i < 1; i++) {
      org.cypher.api.GrpcAPI.Note grpcNote = notes1.getNoteTxs(i).getNote();
    ...
    byte[] memo3 = org.cypher.keystore.Wallet.generateRandomBytes(512);
  ...
  public void decodePaymentAddressIgnoreCase() {
    String addressLower =
        "zcypher1975m0wyg8f30cgf2l5fgndhzqzkzgkgnxge8cwx2wr7m3q7chsuwewh2e6u24yykum0hq8ue99u";
