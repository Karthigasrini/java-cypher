...
import static org.cypher.common.runtime.vm.DataWord.WORD_SIZE;
import static org.cypher.common.utils.BIUtil.addSafely;
import static org.cypher.common.utils.BIUtil.isLessThan;
import static org.cypher.common.utils.BIUtil.isZero;
import static org.cypher.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.cypher.common.utils.ByteUtil.bytesToBigInteger;
import static org.cypher.common.utils.ByteUtil.longTo32Bytes;
import static org.cypher.common.utils.ByteUtil.merge;
import static org.cypher.common.utils.ByteUtil.numberOfLeadingZeros;
import static org.cypher.common.utils.ByteUtil.parseBytes;
import static org.cypher.common.utils.ByteUtil.parseWord;
import static org.cypher.common.utils.ByteUtil.stripLeadingZeroes;
...
import org.cypher.common.crypto.Blake2bfMessageDigest;
...
import org.cypher.common.crypto.zksnark.BN128;
import org.cypher.common.crypto.zksnark.BN128Fp;
import org.cypher.common.crypto.zksnark.BN128G1;
import org.cypher.common.crypto.zksnark.BN128G2;
import org.cypher.common.crypto.zksnark.Fp;
import org.cypher.common.crypto.zksnark.PairingCheck;
...
public class PrecompiledContracts {
  ...
  public static class ValidateMultiSign extends PrecompiledContract {
    ...
    public Pair<Boolean, byte[]> execute(byte[] rawData) {
      ...
      byte[] address = words[0].toCypherAddress();
  ...
  public static class RewardBalance extends PrecompiledContract {
    ...
    public Pair<Boolean, byte[]> execute(byte[] data) {
      ...
      long rewardBalance = VoteRewardUtil.queryReward(
          TransactionTrace.convertToCypherAddress(getCallerAddress()), getDeposit());
  ...
  public static class IsSrCandidate extends PrecompiledContract {
    ...
    public Pair<Boolean, byte[]> execute(byte[] data) {
      ...
      byte[] address = new DataWord(data).toCypherAddress();
  ...
  public static class VoteCount extends PrecompiledContract {
    ...
    public Pair<Boolean, byte[]> execute(byte[] data) {
      ...
      if (accountCapsule != null && !accountCapsule.getVotesList().isEmpty()) {
        ByteString witness = ByteString.copyFrom(words[1].toCypherAddress());
  ...
  public static class TotalVoteCount extends PrecompiledContract {
    ...
    public Pair<Boolean, byte[]> execute(byte[] data) {
      ...
      long cypherPower = accountCapsule != null
          ? accountCapsule.getCypherPower() / CYP_PRECISION : 0;
      return Pair.of(true, longTo32Bytes(cypherPower));
    }
  }
